...
export default function PricingClient() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "How much does ClipVoBooster cost?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "ClipVoBooster offers three plans: Starter at $15/month, Professional at $29/month, and Lifetime at $60 one-time payment. All plans include unlimited AI generation and real-time tracking.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes! You can try ClipVoBooster free before choosing a plan. No credit card required to start.",
        },
      },
      {
        "@type": "Question",
        name: "What's included in the Lifetime plan?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "The Lifetime plan includes all Professional features: 500 emails/month, advanced analytics, custom templates, priority support, and removal of ClipVoBooster branding. Pay once, use forever.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes, you can change your plan at any time. Upgrades are immediate, and downgrades take effect at the next billing cycle.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "We accept all major credit cards and process payments securely through Dodo Payments. Your payment information is encrypted and never stored on our servers.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes, we offer a 30-day money-back guarantee. If you're not satisfied with ClipVoBooster, contact support within 30 days for a full refund.",
        },
      },
    ],
  };
          ...
          {subscription && (
            <div className="alert-box">
              <div className="alert-box-title">
                ✅ You have an active {subscription.planName} plan
              </div>
